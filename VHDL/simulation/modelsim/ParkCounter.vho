...
-- Design Ports Information
-- S[0]	=>  Location: PIN_D5,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
-- B[2]	=>  Location: PIN_B5,	 I/O Standard: 2.5 V,	 Current Strength: Default


ARCHITECTURE structure OF adder3bit IS
SIGNAL gnd : std_logic := '0';
SIGNAL vcc : std_logic := '1';
SIGNAL unknown : std_logic := 'X';
...
\U0|S~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \U0|S~0_combout\ = \A[0]~input_o\ $ (\Cin~input_o\ $ (\B[0]~input_o\))
...
\U0|Cout~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \U0|Cout~0_combout\ = (\A[0]~input_o\ & ((\Cin~input_o\) # (\B[0]~input_o\))) # (!\A[0]~input_o\ & (\Cin~input_o\ & \B[0]~input_o\))
...
\U1|S\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \U1|S~combout\ = \B[1]~input_o\ $ (\A[1]~input_o\ $ (\U0|Cout~0_combout\))
...
\U1|Cout~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
...
\U2|S\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \U2|S~combout\ = \A[2]~input_o\ $ (\B[2]~input_o\ $ (\U1|Cout~0_combout\))
...
\U2|Cout~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \U2|Cout~0_combout\ = (\A[2]~input_o\ & ((\B[2]~input_o\) # (\U1|Cout~0_combout\))) # (!\A[2]~input_o\ & (\B[2]~input_o\ & \U1|Cout~0_combout\))
